...
RegisterNetEvent('actualiza-policia')
AddEventHandler('actualiza-policia', function()
    disponible()
end)
...
--local job = GetPlayerServerId(NetworkGetEntityOwner(GetPlayerPed(-1))),
...
--end)
RegisterCommand("verid", function(source, args, rawCommand) 
    Citizen.Wait(2000)
            while true do
                Citizen.Wait(1)
    ...
    RegisterCommand("disponible", function(source, args, rawCommand) 
    ...
    RegisterCommand("nodisponible", function(source, args, rawCommand) 
